(function() {
	...
	function init() {
		...
		document.querySelector('#indice-svg').setAttribute('height', '350');
		document.querySelector('#indice-svg').setAttribute('width', '380');
		document.querySelector('#indice-svg').setAttribute('viewBox', '0 0 450 250');
